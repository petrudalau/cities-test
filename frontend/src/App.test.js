...
describe('whole APP test', () => {
    ...
    test('render city editor and photo update', () => {
        const {container} = renderWithContexts(Map(), jest.fn(), Map({cityToEdit: {id: 1, name:'city', photo:'http://test.url/'}}), jest.fn());
        expect(container.querySelector('.cities-table-container')).toBeNull();
    ...
    test('handle city editor close', () => {
        ...
        const {container} = renderWithContexts(Map(), cityListDispatch, Map({cityToEdit: {id: 1, name:'city', photo:'test-url'}}), cityUpdateDispatch);
        expect(container.querySelector('.cities-table-container')).toBeNull();
        expect(container.querySelector('.city-editor')).toBeInTheDocument();
    ...
    test('handle city editor save', () => {
        ...
        const {container} = renderWithContexts(Map(), jest.fn(), Map({cityToEdit: {id: 1, name:'city', photo:'test-url'}}), cityUpdateDispatch);
        expect(container.querySelector('.cities-table-container')).toBeNull();
        expect(container.querySelector('.city-editor')).toBeInTheDocument();
    ...
    test('render city save error', () => {
        const {container} = renderWithContexts(Map(), jest.fn(), Map({cityToEdit: {id: 1, name:'city', photo:'test-url'}, saveStatus:'error'}), jest.fn());
        expect(container.querySelector('.cities-table-container')).toBeNull();
        expect(container.querySelector('.city-editor')).toBeInTheDocument();
    ...
    test('render city save success', () => {
        const {container} = renderWithContexts(Map(), jest.fn(), Map({cityToEdit: {id: 1, name:'city', photo:'test-url'}, saveStatus:'stored'}), jest.fn());
        expect(container.querySelector('.cities-table-container')).toBeNull();
        expect(container.querySelector('.city-editor')).toBeInTheDocument();
    ...
    test('render city save ajax loader', () => {
        const {container} = renderWithContexts(Map(), jest.fn(), Map({cityToEdit: {id: 1, name:'city', photo:'test-url'}, loading: true}), jest.fn());
        expect(container.querySelector('.cities-table-container')).toBeNull();
        expect(container.querySelector('.city-editor')).toBeInTheDocument();
